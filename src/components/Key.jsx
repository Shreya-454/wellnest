...
const Key = () => {
  return (
    <section className="xl:mt-32 lg:mt-28 md:mt-20 sm:mt-16 mt-12 lg:h-[404px] max-lg:pb-8 px-2 bg-lightOrange z-[2] relative">
      <img
        src={pupleWave}
        alt="wave"
        width={184.8}
      ...
      <div className="container max-w-[1172px] relative px-4">
        ...
        <div className="flex flex-wrap flex-col-reverse justify-between lg:flex-row -mx-3 items-center">
          <div className="lg:w-7/12 w-full px-3 max-lg:mt-4">
            <h3 className="font-poppins lg:text-start text-center lg:mb-6 sm:mb-4 mb-2 font-semibold !leading-120 sm:text-2xl text-xl text-black lg:max-w618px]">
          ...
          <div className="lg:w-5/12 w-full flex lg:justify-end max-sm:px-6 justify-center px-3">
            <div className="relative z-[2] ">
              ...
              <img
                ...
                width={362.11}
                height={427.94}
                className="max-w-[362px] z-1 shadow-keyImgShadow rounded-[24px] relative top-[-6%]  custom_sm:right-[26px] h-full sm:max-h-[427px] w-full"
              />
              <div className="border-[12px] z-[-1] max-custom_sm:hidden block border-solid border-purple custom_sm:w-[362px] w-[320px] max-custom_sm:ml-3 max-custom_sm:h-[376px] max-sm:h-[425px] absolute top-0 bottom-0 lg:right-0 sm:h-[428px] h-[380px] rounded-[24px]"></div>
            </div>
          </div>
        </div>
      </div>
