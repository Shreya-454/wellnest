  ...
  return (
    <div className=" mt-36 pt-1.5">
      <img
        src={visionImg}
        alt="vision"
        className="max-w-[1920px] max-sm:h-[260px] w-full mx-auto"
      />
      <CommonHeading
      ...
      />
      <p className="md:max-w-[886px] font-poppins font-normal text-center sm:text-base text-sm md:pt-4 pt-2 px-4 mx-auto leading-150 text-black text-opacity-70">
