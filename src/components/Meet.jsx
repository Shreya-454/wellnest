  ...
  return (
    <div className=' relative'>
      ...
      <div className='max-w-[1440px] mx-auto xl:pt-[365px] lg:pt-56 sm:pt-44 pt-24'>
        <div className="container max-w-[1314px] px-3 xl:-translate-x-[5%]">
      ...
      <div className='lg:max-w-[558px] w-full'>
        <CommonHeading heading="Meet " purpleHeading=" Mariam" className=" after:absolute relative after:w-[55px] after:h-[3px] after:bg-purple after:left-0 after:-bottom-2.5 mb-7 max-lg:max-w-[324px] mx-auto max-lg:text-center "/>
